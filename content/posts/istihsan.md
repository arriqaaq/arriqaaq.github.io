---
title: Usul-Al-Fiqh Made Easy (Part 11) - What is الاستحسان (Istihsan)?
slug: istihsan
type: post
published: "2025-04-14T07:30:38.000Z"
updated: "2025-11-04T02:53:12.000Z"
excerpt: Understanding Istihsan
feature_image: /images/2025/04/Screenshot-2025-04-14-at-12.34.14-PM.png
tags:
  - fiqh
authors:
  - arriqaaq
...
In our [previous](/qiyas-debate/) article, we explored the concept of القياس (Qiyas - analogical reasoning) and the scholarly debate surrounding its validity as a source of Islamic fiqh. We examined how the majority of Muslim scholars, including those from the four major madhahib (schools), accept Qiyas as a legitimate tool for deriving ahkam (rulings), while the Zahiri school and scholars like Ibn Ḥazm reject it entirely.
...
### Technical or Legal Definition (المعنى الاصطلاحي)
...
::image{src="/images/2025/04/Screenshot-2025-04-14-at-12.56.50-PM.png" width=full}
...
This includes switching from [Qiyas al-Jali](/what-is-qiyas/) (clear or apparent analogy) to [Qiyas al-Khafi ](/what-is-qiyas/)(subtle or hidden analogy) when the latter is deemed more appropriate for a particular case. In this understanding, Istihsan represents a methodological choice to prefer one type of evidence over another based on its relative strength in a particular context.
...
Although we've explain this in detail in the [article before](/what-is-qiyas/) that, here is a revision to understand this definition more clearly:
...
1️⃣ [**History and Evolution Of Usual Al Fiqh (Part 1)**](/usul-al-fiqh-made-easy-introduction-part-1/)

📝 **Overview: An introduction to Usul Al Fiqh.**

2️⃣  [**Ahlul-Hadith vs Ahlul-Rai (Part 2)**](/usul-al-fiqh-made-easy-difference-between-ahlul-hadith-and-ahlul-rai-part-2/)

📝 **Overview: A comparison of two major approaches to Islamic jurisprudence - Ahlul-Hadith and Ahlul-Rai.**

3️⃣ [**What is Fiqh? (Part 3)**](/usul-al-fiqh-made-easy-part-3-what-is-fiqh/)

📝 **Overview: An introduction to Fiqh, its significance, and the relationship between Fiqh and Usul al-Fiqh.**

4️⃣ [**Books of Fiqh (Part 4)**](/usul-al-fiqh-made-easy-part-4-books/)

📝 **Overview: A dive into the various books and sources that form the foundation of Islamic law.**

5️⃣ [**What is Hukm? (Part 5)**](/usul-al-fiqh-made-easy-part-5-what-is-hukm/)

📝 **Overview: This article explains the concept of Hukm (legal rulings) and its categories in Islamic law.**

6️⃣[**Hukm al-Wadi**](/hukm-al-wadi/) [**(Part 6)**](/hukm-al-wadi/)

📝 **Overview: A detailed explanation of Hukm al-Wadi, its definitions, and its significance in Usul Al Fiqh.**

7️⃣ [**Sources of Al-Hukm: Quran, Sunnah, Ijmaa, and Ijtihaad (Part 7)**](/sources-of-al-hukm-quran-sunnah-ijmaa-and-ijtihaad-usul-al-fiqh-made-easy-part-7/)
