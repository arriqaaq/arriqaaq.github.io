---
title: >-
  Introducing Ilm: Searching the Quran and Sunnah with Graph, Vector, Full-Text
  Search, and LLMs
slug: ilm
type: post
published: "2026-04-10T02:02:52.000Z"
updated: "2026-04-10T14:48:52.000Z"
excerpt: An Open-Source Project for Islamic Knowledge
tags:
  - tech
authors:
  - arriqaaq
...
::image{src="/images/2026/04/Screenshot-2026-04-10-at-7.28.51---AM.png"}

**Ilm** is ***our first*** open-source, collaborative project aimed at making the Qur’an and the Sunnah fully searchable and accessible.

As we prepare to launch our upcoming *Mustalah al-Hadith* series, we recognized the importance of helping users not only read hadith, but also **visualize and interact with their isnads (chains of transmission)**.

::bookmark{url="https://github.com/arriqaaq/ilm" title="GitHub - arriqaaq/ilm" description="Contribute to arriqaaq/ilm development by creating an account on GitHub." author="arriqaaq" publisher="GitHub" icon="/images/icon/pinned-octocat-093da3e6fa40.svg" thumbnail="/images/thumbnail/ilm"}
...
See our launch website on details on how to download it.

::bookmark{url="https://arriqaaq.github.io/ilm/" title="Ilm — Search the Quran & Sunnah" description="A semantic search platform for Islamic scholarship — Quran with tafsir, 34K+ hadiths with narrator chains, and interactive isnad graphs." author="arriqaaq" icon="https://static.ghost.org/v5.0.0/images/link-icon.svg" thumbnail="https://arriqaaq.github.io/ilm/img/feature-search.svg"}
...
::image{src="/images/2026/04/feature-quran.svg" alt="Quran reader with Tajweed Arabic, translation, and tafsir" width=wide}
...
::image{src="/images/2026/04/feature-hadith.svg" alt="Hadith browsing with narrator chains" width=wide}
...
::image{src="/images/2026/04/feature-narrators.svg" alt="Interactive narrator graph visualization" width=wide}
...
::image{src="/images/2026/04/feature-search.svg" alt="Unified search across Quran and Hadith" width=wide}
...
::image{src="/images/2026/04/feature-notes.svg" alt="Study notes with @mentions" width=wide}
...
[https://github.com/arriqaaq/ilm/tree/main#early-manuscripts](https://github.com/arriqaaq/ilm/tree/main#early-manuscripts)Per-ayah manuscript images. Click "Manuscripts" on any ayah to view high-resolution scans of early Quranic manuscripts.

::image{src="/images/2026/04/manuscript-sample.jpg"}
...
::image{src="/images/2026/04/hadith-anatomy.svg" alt="Anatomy of a hadith: sanad (chain of 5 narrators across generations) and matn (text)" width=wide}
...
::image{src="/images/2026/04/narrator-graph.svg" alt="The narrator graph: 18K+ narrators, 34K+ hadiths, ~300K heard_from edges showing cross-links across generations" width=wide}
...
::image{src="/images/2026/04/quran-hadith-links.svg" alt="Quran-Hadith cross-references: ayahs linked to multiple hadiths, tafsir chunked per ayah" width=wide}
...
::image{src="/images/2026/04/arabic-normalization.svg" alt="Arabic normalization: 4 Unicode representations of Abu Hurayrah converge to 1 canonical form" width=wide}
...
::image{src="/images/2026/04/embedding-colocation.svg" alt="Three embedding types (hadith, ayah, tafsir_chunk) co-located with data, enabling single-query RAG retrieval" width=wide}
...
- **tafsir\_chunk** — tafsir commentary is too long for a single embedding, so it's split into ≤1500-char chunks with 200-char overlap; each chunk gets its own embedding
...
::image{src="/images/2026/04/hadith-classification.svg" alt="Complete hadith classification taxonomy" width=wide}
...
::image{src="/images/2026/04/database-comparison.svg" alt="Traditional 4-database approach vs single SurrealDB" width=wide}
...
::image{src="/images/2026/04/architecture.svg" alt="Architecture: SvelteKit → Rust/Axum → SurrealDB + FastEmbed + Ollama" width=wide}
...
::image{src="/images/2026/04/search-flow.svg" alt="Hybrid search: BM25 + Vector → RRF fusion" width=wide}
...
::image{src="/images/2026/04/schema-edges.svg" alt="SurrealQL graph edges with metadata: heard_from, narrates, belongs_to, references_hadith" width=wide}
...
::image{src="/images/2026/04/hybrid-query.svg" alt="Three search strategies (Vector HNSW, English BM25, Arabic BM25) fused via search::rrf()" width=wide}
...
::image{src="/images/2026/04/rag-pipeline.svg" alt="RAG pipeline: embed → intent classification → parallel search → chain traversal → context build → LLM stream" width=wide}
...
- **Chain Continuity Assessment**: Walks each chain checking heard\_from edges, generation gaps, and mursal patterns. Classifies as muttasil, munqati', mursal, mu'allaq, or mu'dal.
...
::image{src="/images/2026/04/ingest-pipeline.svg" alt="Data ingestion pipeline" width=wide}
...
<tbody>
<tr>
<td><a href="https://github.com/A-Kamran/SemanticHadith-V2">SemanticHadith KG V2</a></td>
<td>A. Kamran et al., <em>Journal of Web Semantics</em> 2023</td>
<td>34,457 hadiths, 6,786 narrators</td>
<td>Academic open access</td>
</tr>
<tr>
<td><a href="https://huggingface.co/datasets/meeAtif/hadith_datasets">Sunnah.com translations</a></td>
<td>HuggingFace / sunnah.com</td>
<td>Human English for 6 collections</td>
<td>Various</td>
</tr>
<tr>
<td><a href="https://github.com/somaia02/Narrator-Disambiguation">AR-Sanad</a></td>
<td>Somaia et al., <em>Information</em> 2022</td>
<td>18,298 narrators with Ibn Hajar grades</td>
<td>Open</td>
</tr>
<tr>
<td><a href="https://qul.tarteel.ai/">QUL / Tarteel</a></td>
<td>Tarteel AI</td>
<td>Quran text, translations, tafsir</td>
<td>Open</td>
</tr>
<tr>
<td><a href="https://corpuscoranicum.de/">Corpus Coranicum</a></td>
<td>Berlin-Brandenburg Academy</td>
<td>Early manuscript images</td>
<td>Academic</td>
</tr>
<tr>
<td><a href="https://corpus.quran.com/">corpus.quran.com</a></td>
<td>Leeds University</td>
<td>Word morphology for entire Quran</td>
<td>Open</td>
</tr>
<tr>
<td><a href="https://data.mendeley.com/datasets/5xth87zwb5/5">Sanadset 650K</a></td>
<td>Mendeley Data (PMC 9440281)</td>
<td>650,986 records from 926 books</td>
<td>CC BY 4.0</td>
</tr>
</tbody>
</table>
...
::image{src="/images/2026/04/training-pipeline.svg" alt="Training pipeline: database → Q&A pairs → LoRA → GGUF → Ollama" width=wide}
...
- **LLM** — Train and Build custom llm with the authentic tafsir and hadith collections
